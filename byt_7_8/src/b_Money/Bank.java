 ...
 * - account wasn't added when openAccount() method was called
 * - fixed missing negation in the if statement of deposit() method
 * - fixed fromaccount instead of toaccount in transfer() method
 */
